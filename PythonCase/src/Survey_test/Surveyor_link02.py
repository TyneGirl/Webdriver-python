...
if __name__ == "__main__":
    #import sys;sys.argv = ['', 'TesSendEmailstName']
    testsuite=unittest.TestSuite()
#testsuite.addTest(TesSendEmailetUp"))
    testsuite.addTest(Test("test_SurveyPM"))
#testsuite.addTest(TesSendEmailearDown")) 
    #testsuite.addTest(TesSendEmailest_SurveyPM"))
