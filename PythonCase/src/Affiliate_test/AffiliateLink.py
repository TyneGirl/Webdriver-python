...
class Test(unittest.TestCase):
    ...
    def test_AffiliateLink(self):
        ...
        time.sleep(1)
        affiliatesearch="http://192.168.1.20:9999/affiliate/CommonPages/affiliate_list.html"
        if affiliatesearch==browser.current_url:
            print"点击顶部导航的affiliate search，页面跳转正确！"
        else:
            print"点击顶部导航的affiliate search，页面跳转错误！---<BUG11>"
        time.sleep(1)
        time.sleep(1)
        ...
        time.sleep(1)
        Claimurl="http://192.168.1.20:9999/affiliate/cm/claim_list.html"
        if Claimurl==browser.current_url:
            print"点击顶部导航的的Claim,页面跳转正确！"
        else:
            print"点击顶部导航的Claim，页面跳转错误！---<BUG12>"
        browser.find_element_by_id("btnNew").click()
        time.sleep(1)
        NewClaimurl="http://192.168.1.20:9999/affiliate/cm/claim_detail.html"
        if NewClaimurl==browser.current_url:
            print"点击New，页面进入到New claim页面，页面跳转正确！"
        else:
            print"点击New,页面没有进入New claim页面，页面跳转错误！---<BUG14>"
        ...
        time.sleep(1)
        Contracturl="http://192.168.1.20:9999/affiliate/CMAndCA/contract_compliance_status_list.html"
        if Contracturl==browser.current_url:
            print"点击顶部导航的Contract,页面跳转正确！"
        else:
            print"点击顶部导航的Contract，页面跳转错误！---<BUG13>"
        time.sleep(1)
        ...
        time.sleep(1)
        contractrequesturl="http://192.168.1.20:9999/affiliate/cmandca/request_list.html"
        if contractrequesturl==browser.current_url:
            print"点击顶部导航的Contract Request，页面跳转正确！"
        else:
            print"点击顶部导航的Contract Request，页面跳转正确！---<BUG15>"
        time.sleep(1)
...
#testsuite.addTest(Test("setUp"))
 ...
 #   runner=uSendEmailest.TextTestRunner()
